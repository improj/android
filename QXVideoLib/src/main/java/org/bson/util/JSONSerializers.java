...
public class JSONSerializers {
    ...
    static ClassMapBasedObjectSerializer addCommonSerializers() {
        ...
        serializer.addObjectSerializer(BSONObject.class, new BsonObjectSerializer(serializer));
    ...
    private static class LegacyDateSerializer extends CompoundObjectSerializer {
        ...
        public void serialize(Object obj, StringBuilder buf) {
            ...
            serializer.serialize(
                    new BasicBSONObject("$date", format.format(d)),
                    buf);
        }

    }

    private static class BsonObjectSerializer extends CompoundObjectSerializer {

    	BsonObjectSerializer(ObjectSerializer serializer) {
            super(serializer);
        }
...
**/
    ...
    private static class MaxKeySerializer extends CompoundObjectSerializer {
        ...
        @Override
        public void serialize(Object obj, StringBuilder buf) {
            serializer.serialize(new BasicBSONObject("$maxKey",
                    1), buf);
        }
    ...
    private static class MinKeySerializer extends CompoundObjectSerializer {
        ...
        @Override
        public void serialize(Object obj, StringBuilder buf) {
            serializer.serialize(new BasicBSONObject("$minKey",
                    1), buf);
        }
    ...
    private static class ObjectIdSerializer extends CompoundObjectSerializer {
        ...
        public void serialize(Object obj, StringBuilder buf) {
            serializer.serialize(
                    new BasicBSONObject("$oid", obj.toString()), buf);
        }
    }
    ...
    private static class DateSerializer extends CompoundObjectSerializer {
        ...
        public void serialize(Object obj,  StringBuilder buf) {
            Date d = (Date) obj;
            serializer.serialize(
                    new BasicBSONObject("$date", d.getTime()), buf);
        }
