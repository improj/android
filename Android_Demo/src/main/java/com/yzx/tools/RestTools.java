...
public class RestTools {
    ...
    //http://as.kaixuantx.com:8080/
    private static String LOGIN_URL_PRE = "http://as.kaixuantx.com:8080/"
            + "user/login.do?phone=";
    private static String REG_URL_PRE = "http://as.kaixuantx.com:8080/"
            + "user/reg.do?";
    private static String GROUP_URL_PRE = "http://as.kaixuantx.com:8080/user"
    ...
    public static void initUrl(Context context) {
        ...
        if (!TextUtils.isEmpty(asAddressAndPort)) {
            ...
            //正式环境
            VERI_ADDR = "http://" + "as.kaixuantx.com:8080" + "/";
